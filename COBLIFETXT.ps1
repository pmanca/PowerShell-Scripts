#Script for COB to prefix each line in a text file with LIFE and then
...
$file = "C:\Test\Health Benefits - Life - 02012016 - Copy\Health Benefits - Life - 02032016 -done.txt"
