...
$OutputPath1 = "Z:\ocrff\data\CMS\PUBS\PUBS_" + $DateStr + ".txt"
$OutputPath2 = "Z:\ocrff\data\CMS\NORTH\NORTH_" + $DateStr + ".txt"
$OutputPath3 = "Z:\ocrff\data\CMS\SMD\SMD_" + $DateStr + ".txt"
$OutputPath4 = "Z:\ocrff\data\CMS\NOMATCH\NOMATCH_" + $DateStr + ".txt"
$Pattern1 = "CORRPUBS"
$Pattern2 = "CORRNORTH"
$Pattern3 = "CORRSMD"
$Pattern4 = "\|\|"
