...
function Custom-InputBox
{
 ...
 $userLabel.Text = "Please Enter the name of the output file"
...
function Custom-InputBox2
{
 ...
 $userLabel.Location = New-Object System.Drawing.Size(10,20)
 $userLabel.Size = New-Object System.Drawing.Size(280,20)
 $userLabel.Text = "Please Enter the name of the COB Corrections file"
 $userForm.Controls.Add($userLabel)
 $objTextBox = New-Object System.Windows.Forms.TextBox
 $objTextBox.Location = New-Object System.Drawing.Size(10,40)
 $objTextBox.Size = New-Object System.Drawing.Size(260,20)
...
#$header = "Archive Date|Volume Year|Record Type|Deposition Number|Record Number|DoB|Child First Name|Child Middle Name|Child Last Name|Sex|Father First Name|Father Middle Name|Father Last Name|Mother First Name|Mother Middle Name|Mother Maiden Name|Physician|PoB Street|PoB City|PoB State|PoB Country|Residence Of Parents|Occupation Of Father|Birthplace Of Father|Birthplace Of Mother|Date Of Record|Race|Restricted Record|Delayed Record|Questionable Fields|Flag1|"
...
ForEach-Object{
    $lineCount++
    $errorCount = 0    
        $_ = $_ -replace "Still Birth", "Still Born"
